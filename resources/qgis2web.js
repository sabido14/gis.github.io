...
map.getView().fit([124.466693, 8.164606, 125.331634, 8.585625], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MFWD Pipeline Network System</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (173 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This project was created for the purpose of displaying geographical data in a form of a web-based Geographic Information System for the use of Manolo Fortich Water District.';
            }
